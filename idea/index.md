...
| `rich` | [rich.md](./rich.md) | 2026-05-08 KST | 6 | 오픈 트레이딩 API 서비스 경계·운영 복구·외부 연동 상태를 한곳에서 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-05-08 KST | 4 | 재현 가능한 클론 검증부터 시즌 재현성까지 다루는 KBO 대시보드 허브 |
