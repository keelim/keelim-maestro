...
| `android-support` | [android-support.md](./android-support.md) | 2026-04-27 KST | 6 | Play Console 입력 검증과 릴리스 증적을 묶는 자동화 |
...
| `toto` | [toto.md](./toto.md) | 2026-04-27 KST | 5 | gitlink 등록부터 시즌 재현성까지 다루는 KBO 대시보드 허브 |
