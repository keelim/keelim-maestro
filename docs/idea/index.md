...
| --- | --- | --- | --- | --- |
| `all` | [all.md](./all.md) | 2026-09-25 KST | 6 | 공통 모듈 채택·크로스 플랫폼(KMP/iOS/Rust) 빌드 게이트·릴리스 리스크를 함께 낮추는 허브 |
| `all-web-ui` | [all-web-ui.md](./all-web-ui.md) | 2026-09-25 KST | 6 | 공용 토큰·프리미티브 계약과 다운스트림 영향 가시화 허브 |
| `android-support` | [android-support.md](./android-support.md) | 2026-09-25 KST | 5 | Play Console 입력 검증과 릴리스 증적을 묶는 자동화 |
| `Keelim-Knowledge-Vault` | [Keelim-Knowledge-Vault.md](./Keelim-Knowledge-Vault.md) | 2026-09-25 KST | 6 | 워크스페이스 기준선과 문서 스냅샷을 다시 찾게 만드는 허브 |
| `keelim-plugin` | [keelim-plugin.md](./keelim-plugin.md) | 2026-09-25 KST | 6 | 스킬 카탈로그와 설치·회귀 검증을 함께 다루는 개인 플러그인 저장소 |
| `keelim-vercel` | [keelim-vercel.md](./keelim-vercel.md) | 2026-09-25 KST | 6 | 후속 행동 루프와 저장소 계약을 함께 다루는 금융 허브 |
| `rich` | [rich.md](./rich.md) | 2026-09-25 KST | 6 | 운영 복구와 외부 연동 상태를 한곳에서 다루는 관리자 허브 |
| `youtube` | [youtube.md](./youtube.md) | 2026-09-25 KST | 2 | 렌더러·서비스·릴리즈 노트 자동화를 하나의 파이프라인 시야로 묶는 허브 |

## Archived projects

| Path | File | Why archived |
| --- | --- | --- |
| `toto` | [toto.md](./toto.md) | `AGENTS.md`의 `/toto` 아카이브 정책(2026-06-04부)에 따라 루트 조정 레이어의 활성 프로젝트 테이블에서 제외. 사용자가 명시적으로 재활성화를 요청하기 전까지 idea gardener의 활성 대상이 아니며, 기존 아이디어는 이력 참고용으로 `toto.md`에 남겨둔다. |
...
| `quant` | `AGENTS.md` 정책상 원격 저장소가 없어 루트 대상에서 의도적으로 제외됨; 사용자가 명시적으로 요청하기 전까지 백로그 대상으로 승격하지 않는다 |
