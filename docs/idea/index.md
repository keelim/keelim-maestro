...
| --- | --- | --- | --- | --- |
| `all` | [all.md](./all.md) | 2026-07-04 KST | 6 | 공통 모듈 채택·크로스 플랫폼(KMP/iOS/Rust) 빌드 게이트·릴리스 리스크를 함께 낮추는 허브 |
| `all-web-ui` | [all-web-ui.md](./all-web-ui.md) | 2026-07-04 KST | 4 | 루트 `report:shared-ui` 컨트롤타워를 CI 게이트로 승격하고, 남은 진짜 격차인 시각·접근성 회귀 자동화에 집중 |
| `android-support` | [android-support.md](./android-support.md) | 2026-07-04 KST | 5 | Play Console 입력 검증과 릴리스 증적을 묶는 자동화 |
| `Keelim-Knowledge-Vault` | [Keelim-Knowledge-Vault.md](./Keelim-Knowledge-Vault.md) | 2026-07-04 KST | 6 | 워크스페이스 기준선과 문서 스냅샷을 다시 찾게 만드는 허브 |
| `keelim-plugin` | [keelim-plugin.md](./keelim-plugin.md) | 2026-07-04 KST | 6 | 스킬 카탈로그와 설치·회귀 검증을 함께 다루는 개인 플러그인 저장소 (keelim-skill 리네이밍은 완료) |
| `keelim-vercel` | [keelim-vercel.md](./keelim-vercel.md) | 2026-07-04 KST | 6 | 후속 행동 루프와 저장소 계약을 함께 다루는 금융 허브 |
| `rich` | [rich.md](./rich.md) | 2026-07-04 KST | 5 | 운영 콘솔 통합(실행·재시도 / 신선도·헬스)과 all-web-ui 잔여 drift 축소를 함께 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-07-04 KST | 3 | gitlink 등록은 완료(해결됨), 시즌 재현성에 집중하는 KBO 대시보드 허브 |
