...
| `rich` | [rich.md](./rich.md) | 2026-06-09 KST | 6 | 운영 복구·외부 연동·작업 트리 기준선 정리를 함께 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-06-09 KST | 4 | gitlink 핀 CI 검증부터 시즌 재현성까지 다루는 KBO 대시보드 허브 |
