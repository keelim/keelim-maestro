...
| `keelim-plugin` | [keelim-plugin.md](./keelim-plugin.md) | 2026-05-25 KST | 6 | 스킬 카탈로그·설치·회귀 검증과 세션 훅 인프라를 함께 다루는 개인 플러그인 저장소 |
| `keelim-vercel` | [keelim-vercel.md](./keelim-vercel.md) | 2026-05-16 KST | 6 | 후속 행동 루프와 저장소 계약을 함께 다루는 금융 허브 |
| `rich` | [rich.md](./rich.md) | 2026-05-25 KST | 6 | 운영 복구·KIS MCP·백테스터·전략 빌더 가시성을 한곳에서 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-05-25 KST | 4 | gitlink pinning 완료 후 CI 재현성 통합까지 다루는 KBO 대시보드 허브 |
