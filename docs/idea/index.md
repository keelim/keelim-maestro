...
| `android-support` | [android-support.md](./android-support.md) | 2026-05-29 KST | 6 | Play Console 입력 검증·릴리스 증적·서브모듈 핀 드리프트를 함께 다루는 자동화 |
...
| `toto` | [toto.md](./toto.md) | 2026-05-29 KST | 4 | CI 클론 체인 검증과 시즌 재현성을 다루는 KBO 대시보드 허브 |
