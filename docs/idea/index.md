...
| `keelim-plugin` | [keelim-plugin.md](./keelim-plugin.md) | 2026-06-07 KST | 6 | 스킬 카탈로그·설치·회귀 검증과 세션 학습 분석을 함께 다루는 개인 플러그인 저장소 |
| `keelim-vercel` | [keelim-vercel.md](./keelim-vercel.md) | 2026-06-07 KST | 6 | 후속 행동 루프·업적 시스템·저장소 계약을 함께 다루는 금융 허브 |
| `rich` | [rich.md](./rich.md) | 2026-06-07 KST | 6 | 운영 복구·외부 연동·오픈트레이딩 API 경계를 한곳에서 다루는 관리자 허브 |
