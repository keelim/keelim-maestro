...
| `rich` | [rich.md](./rich.md) | 2026-05-19 KST | 6 | 운영 복구·외부 연동(KIS MCP 포함) 상태를 한곳에서 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-05-19 KST | 5 | gitlink 등록·시즌 재현성·예측 모델 계약을 다루는 KBO 대시보드 허브 |
