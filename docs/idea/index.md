...
| --- | --- | --- | --- | --- |
| `all` | [all.md](./all.md) | 2026-07-09 KST | 6 | 공통 모듈 채택·크로스 플랫폼(KMP/iOS/Rust) 빌드 게이트·릴리스 리스크를 함께 낮추는 허브 |
| `all-web-ui` | [all-web-ui.md](./all-web-ui.md) | 2026-07-09 KST | 4 | export/import 계약 검증은 스크립트로 해소됨; 남은 축은 시각·접근성 회귀와 `rich` 클린업 이후 서브모듈 전환 준비 |
| `android-support` | [android-support.md](./android-support.md) | 2026-07-09 KST | 5 | Play Console 입력 검증과 릴리스 증적을 묶는 자동화 |
| `Keelim-Knowledge-Vault` | [Keelim-Knowledge-Vault.md](./Keelim-Knowledge-Vault.md) | 2026-07-09 KST | 6 | 워크스페이스 기준선과 문서 스냅샷을 다시 찾게 만드는 허브 |
| `keelim-plugin` | [keelim-plugin.md](./keelim-plugin.md) | 2026-07-09 KST | 6 | 스킬 카탈로그와 설치·회귀 검증을 함께 다루는 개인 플러그인 저장소 |
| `keelim-vercel` | [keelim-vercel.md](./keelim-vercel.md) | 2026-07-09 KST | 5 | 공용 UI 어댑터 경계는 검증 스크립트로 해소됨; 후속 행동 루프와 남은 저장소 계약 드리프트에 집중 |
| `rich` | [rich.md](./rich.md) | 2026-07-09 KST | 6 | 운영 복구와 외부 연동 상태를 한곳에서 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-07-09 KST | 4 | gitlink pinning은 완료됨; 남은 초점은 CI 재현 클론 게이트와 시즌 재현성 |
