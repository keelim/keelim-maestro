...
| --- | --- | --- | --- | --- |
| `all` | [all.md](./all.md) | 2026-04-25 KST | 6 | 공통 모듈 채택·크로스 플랫폼(KMP/iOS/Rust) 빌드 게이트·릴리스 리스크를 함께 낮추는 허브 |
| `all-web-ui` | [all-web-ui.md](./all-web-ui.md) | 2026-05-16 KST | 6 | 공용 토큰·프리미티브 계약과 다운스트림 영향 가시화 허브 |
| `android-support` | [android-support.md](./android-support.md) | 2026-05-16 KST | 6 | Play Console 입력 검증, 릴리스 증적, 버전 범프 결정을 묶는 자동화 |
...
| `rich` | [rich.md](./rich.md) | 2026-05-16 KST | 6 | 운영 복구·외부 연동·KIS MCP 상태를 한곳에서 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-05-16 KST | 4 | 재현 파이프라인 CI 통합부터 공급자 인터페이스까지 다루는 KBO 대시보드 허브 |
