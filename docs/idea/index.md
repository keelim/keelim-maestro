...
| `android-support` | [android-support.md](./android-support.md) | 2026-06-01 KST | 6 | Play Console 입력 검증과 릴리스 증적을 묶는 자동화 |
...
| `rich` | [rich.md](./rich.md) | 2026-06-01 KST | 6 | 운영 복구와 외부 연동 상태를 한곳에서 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-06-01 KST | 3 | 시즌 재현성과 공급자 교체 안정성을 함께 다루는 KBO 대시보드 허브 |
