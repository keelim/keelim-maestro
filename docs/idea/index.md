...
| --- | --- | --- | --- | --- |
| `all` | [all.md](./all.md) | 2026-08-06 KST | 6 | 공통 모듈 채택·크로스 플랫폼(KMP/iOS/Rust) 빌드 게이트·릴리스 리스크를 함께 낮추는 허브 |
| `all-web-ui` | [all-web-ui.md](./all-web-ui.md) | 2026-08-06 KST | 5 | 공용 토큰·프리미티브 계약 가시화와, 이미 구현된 검증 스크립트를 CI 게이트로 승격하는 허브 |
| `android-support` | [android-support.md](./android-support.md) | 2026-08-06 KST | 4 | Play Console 입력 검증과 릴리스 증적을 묶는 자동화 (계약 드리프트 검사는 이미 CI에 반영됨) |
| `Keelim-Knowledge-Vault` | [Keelim-Knowledge-Vault.md](./Keelim-Knowledge-Vault.md) | 2026-08-06 KST | 6 | 워크스페이스 기준선과 문서 스냅샷을 다시 찾게 만드는 허브 |
| `keelim-plugin` | [keelim-plugin.md](./keelim-plugin.md) | 2026-08-06 KST | 5 | 스킬 카탈로그·검증 자동화는 이미 구현됐고, 남은 초점은 capability 필터 뷰와 Codex/Claude 실행 동등성 |
| `keelim-vercel` | [keelim-vercel.md](./keelim-vercel.md) | 2026-08-06 KST | 6 | 후속 행동 루프와 저장소 계약을 함께 다루는 금융 허브 |
| `rich` | [rich.md](./rich.md) | 2026-08-06 KST | 6 | 운영 복구와 외부 연동 상태를 한곳에서 다루는 관리자 허브 |
| `toto` | [toto.md](./toto.md) | 2026-08-06 KST | 4 | gitlink는 커밋 완료, 남은 초점은 클론→부트스트랩→시드→검증 전체 흐름의 재현성 증적 |
