...
| `all-web-ui` | [all-web-ui.md](./all-web-ui.md) | 2026-06-23 KST | 6 | 공용 토큰·프리미티브 계약과 다운스트림 영향 가시화 허브 (`@0.1.4` React 19·Tailwind 4; 서브모듈 등록 rich git 상태 해소 대기) |
...
| `rich` | [rich.md](./rich.md) | 2026-06-23 KST | 6 | 운영 복구와 외부 연동 상태를 한곳에서 다루는 관리자 허브 (git dirty/ahead → 서브모듈 확장 차단 요소; 정리 선행 필요) |
| `toto` | [toto.md](./toto.md) | 2026-06-23 KST | 5 | gitlink 등록·uv 워크스페이스 제약 준수·시즌 재현성까지 다루는 KBO 대시보드 허브 |
