...
- `toto`의 gitlink는 이제 루트 인덱스에 커밋되어 등록 submodule로 pinning되어 있다(`docs/CODEMAPS/SUBMODULES.md` 기준 `5897ef44`, `backend.md`/`WORKSPACE.md`에서도 active Bun+uv workspace member로 확인됨) — 이전에 열려 있던 gitlink 미커밋 리스크는 해소됨.
