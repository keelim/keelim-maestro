...
- gitlink가 루트 인덱스에 커밋(`5897ef44`)되어 재현 가능한 클론·부트스트랩 흐름이 확인됐다(2026-06-30 코드맵 기준).
- 코드맵 기준 29개 파일(Python 18, 테스트 5); `test_no_recommendation_surface`가 앱 소스 표현 금지 계약을 검증한다.
