...
Resolved: 2026-08-14 KST

Evidence: 루트 `git ls-files --stage | grep 160000`에 `toto`가 pinned commit `5897ef441cb13c550c83a5392097bc46423b3391`로 커밋된 gitlink로 잡히고, `docs/CODEMAPS/SUBMODULES.md`도 `toto`를 등록 submodule로 기록한다. 신규 클론에서 `git submodule update --init toto` 실행 전제였던 루트 인덱스 gitlink 누락 문제는 해소되었다.
