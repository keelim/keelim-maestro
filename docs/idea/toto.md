...
- 2026-08-13 확인: `git ls-files --stage | grep 160000`에 `toto` gitlink(`5897ef44`)가 커밋되어 있어, 아래에 있던 "gitlink 미등록" 위험은 해소됐다. 신규 클론에서는 여전히 `git submodule update --init toto`로 로컬 체크아웃을 별도로 받아야 한다.
