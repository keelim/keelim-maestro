...
- `toto`의 gitlink는 이제 루트 인덱스에 커밋되어 있다(`git ls-tree HEAD -- toto` → `160000 commit 5897ef441cb13c550c83a5392097bc46423b3391`), `docs/CODEMAPS/SUBMODULES.md`의 pinned 커밋과 일치. 2026-04-25에 제기했던 "gitlink 미커밋" 클론 게이트 문제는 2026-08-12 확인 결과 해결됨 — 관련 open idea 제거.
