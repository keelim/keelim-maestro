...
## Key Directories
- `skills/`: 10 files; examples: `skills/codebase-codemap/SKILL.md`, `skills/codebase-codemap/agents/openai.yaml`, `skills/codebase-codemap/references/codemap-schema.md`
- `./`: 1 files; examples: `README.md`
