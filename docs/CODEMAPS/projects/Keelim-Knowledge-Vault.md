...
## Key Directories
- `./`: 34 files; examples: `.gitignore`, `Android.md`, `Applier.md`
- `Android/`: 26 files; examples: `Android/Component/App Bundle.md`, `Android/Component/App manifest file.md`, `Android/Component/Baseline Profile.md`
- `service/`: 25 files; examples: `service/auth/Auth.md`, `service/auth/FIDO.md`, `service/auth/HTTPS.md`
...
- `.github/`: 1 files; examples: `.github/workflows/build_docs.yml`
