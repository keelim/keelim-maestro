...
| --- | --- | ---: | --- |
| `Keelim-Knowledge-Vault` | [Keelim-Knowledge-Vault.md](Keelim-Knowledge-Vault.md) | 239 | Source repository |
| `all` | [all.md](all.md) | 1,013 | Java/Kotlin/Gradle |
| `all-web-ui` | [all-web-ui.md](all-web-ui.md) | 51 | Node/JavaScript |
| `android-support` | [android-support.md](android-support.md) | 35 | Node/JavaScript |
